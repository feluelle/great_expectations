...
from great_expectations.datasource.batch_kwarg_generator import TableBatchKwargsGenerator
...
def test_query_generator_view(sqlite_view_engine):
    datasource = SqlAlchemyDatasource(engine=sqlite_view_engine, batch_kwarg_generators={
        "table": {
