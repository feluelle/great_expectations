...
def test_setting_config_variables_is_visible_immediately(data_context_with_variables_in_config):
    ...
    assert context.get_config()["datasources"]["mydatasource"]["batch_kwarg_generators"]["mygenerator"][
    ...
    # the context's config has two config variables - one using the ${} syntax and the other - $.
    assert context.get_config_with_variables_substituted()["datasources"]["mydatasource"]["batch_kwarg_generators"][
    ...
    context._project_config["datasources"]["mydatasource"]["batch_kwarg_generators"]["mygenerator"]["reader_options"][
    ...
    try:
        ...
        assert context.get_config_with_variables_substituted()["datasources"]["mydatasource"]["batch_kwarg_generators"]["mygenerator"][
