...
class SparkDFDatasource(Datasource):
    ...
    filesystem (the default subdir_reader batch kwarg  generator) and databricks notebooks.
    ...
    @classmethod
    def build_configuration(cls, data_asset_type=None, batch_kwarg_generators=None, spark_config=None, **kwargs):
        """
    ...
    def __init__(self, name="default", data_context=None, data_asset_type=None, batch_kwarg_generators=None,
        ...
        Args:
            ...
            batch_kwarg_generators: generator configuration
            spark_config: dictionary of key-value pairs to be set on the spark session builder
            **kwargs: Additional
        """
        configuration_with_defaults = SparkDFDatasource.build_configuration(data_asset_type, batch_kwarg_generators,
                                                                            spark_config, **kwargs)
