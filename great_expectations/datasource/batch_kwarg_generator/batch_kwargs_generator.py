...
class BatchKwargsGenerator(object):
    ...
    For example, a batch kwarg generator could produce a SQL query that logically represents "rows in
    ...
    assembled by the batch kwarg generator, While not every datasource will enable re-fetching a
