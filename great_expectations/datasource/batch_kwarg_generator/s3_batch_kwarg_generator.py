...
class S3GlobReaderBatchKwargsGenerator(BatchKwargsGenerator):
    """
    S3 BatchKwargGenerator provides support for generating batches of data from an S3 bucket. For the S3 batch kwarg generator, assets must
    ...
    def __init__(self,
        ...
        Args:
            name: the name of the batch kwarg generator
        ...
        try:
            ...
            raise(ImportError("Unable to load boto3, which is required for S3 batch kwarg generator"))
